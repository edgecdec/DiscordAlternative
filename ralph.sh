#!/bin/bash
# Ralph-style autonomous development loop for Discord Alternative
...
MAX=${1:-0}
COUNT=0
LOG_DIR="/tmp/ralph-discord-logs"
mkdir -p "$LOG_DIR"

echo "💬 Ralph is starting for DiscordAlternative (max iterations: ${MAX:-unlimited})"
echo ""
...
while true; do
  ...
  # Count open vs done tasks from prd.json
