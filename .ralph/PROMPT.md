...
11. If validation passes: update the task status to `"done"` in prd.json, append lessons to `.ralph/progress.txt`, then: `git add -A && git commit -m "TASK-XXX: short description" && git push`.
